...
void CustomBLE::encrypt(const unsigned char* input, const char* key, unsigned char* output)
{
...
void CustomBLE::buildPaket() {
  ...
  if (encryption_enabled) {
    ...
    CustomBLE::encrypt(serviceDataArr, encryption_key.c_str(), cipherOutput);
